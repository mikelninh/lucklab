---
title: "Decision Fatigue — The Real Mechanism, the Real Cure"
slug: "decision-fatigue"
description: "Steve Jobs wore the same clothes — but that is not the lesson. The popular advice on decision fatigue is mostly wrong, the original research has serious replication issues, and the actual cure is not fewer choices but the right architecture. Here is the honest version."
targetKeyword: "decision fatigue"
...
- **Ego depletion as a unified "willpower battery" is not well-supported.** Most rigorous replications fail to find it.
- **Decision-making does degrade across long stretches of cognitive load** — but the mechanism is closer to *task-switching cost*, *working memory exhaustion*, and *uncomfortable affect* than a single depleting resource.
- **Self-perception of fatigue matters as much as objective fatigue.** People who *believe* their willpower is finite show different behaviour than people who don't — independent of any actual depletion.
- **Glucose, sleep, and emotional state affect decision quality reliably.** These are not the "battery model" — they are real physiological factors with separate mechanisms.
...
The [Reading](/reading) takes three minutes. Ten questions. No signup. It returns your specific profile of *signal clarity* across the twelve areas — which is, more often than not, the actual fatigue underneath the decision fatigue.
...
Related reading: [How to Make a Hard Decision — A Field Framework](/research/how-to-make-a-hard-decision) · [The 10-Second Test That Proves What You're Secretly Hoping For](/research/10-second-test) · [Abundance Isn't Having More. It's Noticing More.](/research/abundance)
