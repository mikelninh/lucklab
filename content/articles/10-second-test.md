---
title: "The 10-Second Test That Proves What You're Secretly Hoping For"
slug: "10-second-test"
description: "A decision-making test borrowed from psychology: flip a coin, don't look, ask yourself which side you were hoping it landed on. The answer is your answer. The coin was never deciding."
...
1. Pick the two options you're stuck between. Call them **A** and **B**.
2. Assign heads = A, tails = B.
3. Flip a coin. Don't look at it yet. *(No coin? Imagine flipping one. The trick works either way.)*
4. In the half-second the coin is in the air, ask yourself one question:
